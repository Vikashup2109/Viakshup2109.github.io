                    ...
                    <nav className='px-4 xsm:px-6 max-w-6xl h-10 md:h-16 mx-auto flex justify-between items-center gap-x-4'>
                         ...
                         <div className={toggle ? 'nav_menu show_menu' : 'nav_menu'}>
                              <ul className='grid grid-cols-3 gap-x-0 gap-8 md:flex md:gap-x-8 items-center' id='ul'>
                                   <li className={active_tab === "#home" ? "active-tab" : ""}>
                                   ...
                                   <li className={active_tab === "#about" ? "active-tab" : ""}>
                                   ...
                                   <li className={active_tab === "#expertise" ? "active-tab" : ""}>
                                        <a href="#expertise" className='btn flex flex-col items-center text-small font-medium text-titleColor hover:text-titleColorDark' onClick={ExpertiseScroll}>
                                             <i className="uil uil-file-alt nav_icon block text-xl md:hidden"></i> Expertise
                                        </a>
                                   </li>

                                   <li className={active_tab === "#projects" ? "active-tab" : ""}>
                                        <a href="#projects" className='btn flex flex-col items-center text-small font-medium text-titleColor hover:text-titleColorDark' onClick={ProjectsScroll}>
                                             <i className="uil uil-scenery block text-xl md:hidden"></i> Projects
                                        </a>
                                   </li>
                                   <li className={active_tab === "#thoughts" ? "active-tab" : ""}>
                                        <a href="#tboughts" className='btn flex flex-col items-center text-small font-medium text-titleColor hover:text-titleColorDark' onClick={ThoughtsScroll}>
                              ...
                              <i className="uil uil-times absolute right-5 bottom-2 text-2xl hover:text-titleColorDark block md:hidden" onClick={() => setToggle(!toggle)}></i>
                         </div>
